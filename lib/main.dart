          ...
          AppBar appBar(BuildContext appBarContext, {bool isInnerScaffold = false}) {
            ...
            return AppBar(
              title: _isSearching
                ...
                autofocus: true,
                decoration: InputDecoration(hintText: 'Search in $_currentAppBarTitle...', border: InputBorder.none, hintStyle: TextStyle(color: Theme.of(appBarContext).colorScheme.onPrimary.withOpacity(0.7))),
                style: TextStyle(color: Theme.of(appBarContext).colorScheme.onPrimary, fontSize: 18),
              )
